    ...
    >
      <ThemeProvider theme={theme}>
        ...
        <Typography variant="h5" component="p" sx={{ textAlign: "center" }}>
          「東吳課程評價」是一個旨在提供東吳大學學生更公正、透明的課程與教授評價平台的網站。 <br />
          作為一個學生，你可能會對即將修課的教授有許多疑問，例如教學風格、課業難度、評分方式等等。透過「東吳課程評價」，你可以輕鬆地查詢到教授的歷年成績分布，了解其授課難度與評分標準。同時，你也可以發表對教授的評價，分享自己的課程經驗，並且幫助其他學生作出更好的選擇。
          <br />
          <br />
          本站收錄了105學年至110學年第1學期之所有課程的成績分布。自110學年第2學期開始之課程成績皆為同學自行上傳，不保證課程成績之正確性。
        </Typography>
        <Search>
